        ...
        <div className={`px-5 pt-3 pb-5 lg3:ml-[240px]`}>
           ...
           <div className="mt-5">
            <div className="flex items-center justify-between">
                ...
                <div className="w-[90px] py-4 bg-[#F3F1F1] skeleton-box rounded-full"></div>
            </div>
            ...
            {video.map((ele, index) => (
              ...
              <div className="w-[160px] py-3 bg-[#F3F1F1] skeleton-box rounded-full"></div>
                ...
                <td className="px-[40px] whitespace-nowrap">
                  ...
                  <div className="w-[140px] py-6 bg-[#F3F1F1] skeleton-box rounded-full"></div>
