            ...
            return (
              ...
              >
                <button className="w-full flex flex-col">
                 <div className='bg-[#C4C4C4] text-[#EFEFEF] rounded-md font-[700] text-[23px] w-full flex items-center justify-center flex-col text-center h-[130px] p-3 mb-3'>Product</div>
                 <div className="w-full text-center">{ele.productName}</div>
                </button>
              </SwiperSlide>
            );
          })}
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              <div>
                ...
                <button onClick={closeModal} className='buttonShadow w-full flex items-center justify-center py-3 transition bg-main hover:bg-main-hover text-white rounded-full mt-7'>Add Product</button>
              </div>
           </div>
