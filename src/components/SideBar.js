         ...
         <div className="flex justify-between flex-col gap-7 h-[calc(100%-78px)]">
            <div className="flex flex-col gap-7">
             <div className={`overflow-hidden transition-[height] ${dropDown === false ? "h-[24px]" : "h-[143px]"}`}>
                ...
                <Link to="/dashboard/customer-viewpoint" className={`flex font-[500] w-full pl-[35px] mt-4 ${location.pathname === "/dashboard/customer-viewpoint" ? "text-main" : "text-[#828282]"}`}>Customer Viewpoint</Link>
             </div>
