            ...
            <div className="text-[19px] font-[500] mb-3">My Profile</div>
             <div className="cardShadow bg-white rounded-xl flex items-center flex-col md:flex-row gap-8 p-7 mb-8">
                ...
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] px-5 focus-within:border-main h-[60px]">
                    ...
                    <input type="text" placeholder='John Carter' className='w-full border-none outline-none h-full text-[15px]' />
                </div>
                ...
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] px-5 focus-within:border-main h-[60px] mt-8">
                    ...
                    <input type="email" placeholder='JohnCarter@email.com' className='w-full border-none outline-none h-full text-[15px]' />
                </div>
