        ...
        <div className={`bg-white w-full max-w-[600px] mx-auto rounded-md p-7 ${mainScreen === "login" ? "block" : "hidden"}`}>
          {
           ...
           <div className={`w-full ${screen === 2 ? "" : "hidden"}`}>
              ...
              <div>
                ...
                <button onClick={progress} className='buttonShadow w-full flex items-center justify-center py-3 bg-main text-white rounded-full mt-10'>Add Brand</button>
           ...
           <div className={`w-full ${screen === 3 ? "" : "hidden"}`}>
              ...
              <div>
                ...
                <button onClick={progress} className='buttonShadow w-full flex items-center justify-center py-3 bg-main text-white rounded-full mt-10'>Add Product</button>
           ...
           <div className={`w-full ${screen === 4 ? "" : "hidden"}`}>
              ...
              <div>
                ...
                <button onClick={progress} className='buttonShadow w-full flex items-center justify-center py-3 bg-main text-white rounded-full mt-10'>Create Report</button>
              </div>
           </div>
