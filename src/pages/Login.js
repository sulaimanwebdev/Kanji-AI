      ...
      <div className='max-w-[600px] mx-auto relative'>
        ...
        <div className={`bg-white w-full max-w-[600px] mx-auto rounded-md p-7 ${mainScreen === "login" ? "block" : "hidden"}`}>
           ...
           <div className={`w-full ${screen === 1 ? "" : "hidden"}`}>
              ...
              <div>
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] px-4 focus-within:border-main h-[60px]">
                    <div className="text-[#6E6E6E] text-[15px] font-[500] absolute -top-[10px] left-4 bg-white px-2">Full Name</div>
                ...
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] px-4 focus-within:border-main h-[60px] mt-8">
                    <div className="text-[#6E6E6E] text-[15px] font-[500] absolute -top-[10px] left-4 bg-white px-2">Email</div>
                ...
                <div className="relative w-full flex items-center gap-2 rounded-md border-solid border border-[#AAAAAA] px-4 focus-within:border-main h-[60px] mt-8">
                    <div className="text-[#6E6E6E] text-[15px] font-[500] absolute -top-[10px] left-4 bg-white px-2">Password</div>
                ...
                <div className="relative w-full flex items-center gap-2 rounded-md border-solid border border-[#AAAAAA] px-4 focus-within:border-main h-[60px] mt-8">
                    <div className="text-[#6E6E6E] text-[15px] font-[500] absolute -top-[10px] left-4 bg-white px-2">Confirm Password</div>
                ...
                <button onClick={progress} className='buttonShadow w-full flex items-center justify-center py-3 bg-main text-white rounded-full mt-10'>Create Account</button>
