           ...
           <div className={`w-full ${screen === 1 ? "" : "hidden"}`}>
              ...
              <div>
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] focus-within:border-main h-[60px]">
                    ...
                    <input type="text" placeholder='John Carter' className='w-full border-none outline-none h-full text-[15px] px-5 rounded-md' value={fullName} onChange={(e)=> {setfullName(e.target.value)}} />
                </div>
                ...
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] focus-within:border-main h-[60px] mt-8">
                    ...
                    <input type="email" placeholder='JohnCarter@email.com' className='w-full border-none outline-none h-full text-[15px] px-5 rounded-md' value={email} onChange={(e)=> {setemail(e.target.value)}} />
                </div>
           ...
           <div className={`w-full ${screen === 2 ? "" : "hidden"}`}>
              ...
              <div>
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] focus-within:border-main h-[60px]">
                    ...
                    <input type="text" placeholder='Enter your Brand name' className='w-full border-none outline-none h-full text-[15px] px-5 rounded-md' value={brandName} onChange={(e)=> {setbrandName(e.target.value)}} />
                </div>
                ...
                <div className="relative w-full flex items-start rounded-md border-solid border border-[#AAAAAA] focus-within:border-main min-h-[150px] pb-2 mt-8">
                    ...
                    <textarea placeholder='Include information about what the brand does, what its values are, or any other relevant details.' className='w-full resize-none border-none outline-none min-h-[150px] text-[15px] px-5 rounded-md mt-4' value={brandDescription} onChange={(e)=> {setbrandDescription(e.target.value)}}></textarea>
                </div>
           ...
           <div className={`w-full ${screen === 3 ? "" : "hidden"}`}>
              ...
              <div>
                <div className="relative w-full flex items-center rounded-md border-solid border border-[#AAAAAA] focus-within:border-main h-[60px]">
                    ...
                    <input type="text" placeholder='Enter your Product name' className='w-full border-none outline-none h-full text-[15px] px-5 rounded-md' />
                </div>

                <div className="relative w-full flex items-start rounded-md border-solid border border-[#AAAAAA] focus-within:border-main min-h-[150px] pb-2 mt-8">
                    <div className="text-[#6E6E6E] text-[15px] font-[500] absolute -top-[10px] left-3 bg-white px-2">Product Description</div>
                    <textarea placeholder='Include information about what the product does, or any other relevant details.' className='w-full resize-none border-none outline-none min-h-[150px] text-[15px] px-5 rounded-md mt-4' ></textarea>
                </div>
